...
def runDiffusionMetricsAlongCutExtremitiesBundles( subjectDirectoryFiberLabelling,
  ...
  fileNameResampledWMBundles = os.path.join( 
                                 outputDirectory,
                                 'white_matter_bundles-resampled.bundles' )

  CommandFactory().executeCommand(
      { 'algorithm' : 'DwiBundleOperator',
        'parameters' : \
          { 'fileNameInputBundleMaps' : str( fileNameOrderedBundleMap ),
            'fileNameOutputBundleMaps' : str( fileNameResampledWMBundles ),
  ...
  # Cut extremities
  fileNameCutExtremitiesWMBundles = os.path.join( 
                                 outputDirectory,
                                 'white_matter_bundles-cutExtremities.bundles' )

  CommandFactory().executeCommand(
      { 'algorithm' : 'DwiBundleOperator',
        'parameters' : \
          { 'fileNameInputBundleMaps' : str( fileNameResampledWMBundles ),
            'fileNameOutputBundleMaps' : str( fileNameCutExtremitiesWMBundles ),
  ...
  CommandFactory().executeCommand(
      { 'algorithm' : 'DwiBundleMeasure',
        'parameters' : \
          { 'fileNameBundleMap' : str( fileNameCutExtremitiesWMBundles ),
