...
def runMorphologistPipeline( subjectDirectoryGisConversion,
  ...
  if ( verbose == True ):
    ...
    print( "COMPUTING MORPHOLOGIST PIPELINE" )
    print( "-------------------------------------------------------------" )
  ...
  fileNameT1 = os.path.join( subjectDirectoryGisConversion, 
                             't1-mprage.ima' )
    ...
    { 'algorithm' : 'Registration3d',
      'parameters' : \
        { 'referenceName' : str( fileNameUnbiasedT1 ),
          ...
          'outputName' : str( fileNameDwToT1Transform3d ),
          'outputInverseName' : str( fileNameT1ToDwTransform3d ),
