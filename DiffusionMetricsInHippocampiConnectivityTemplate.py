...
def runDiffusionMetricsInHippocampiConnectivityTemplate( 
  ...
  fileNameHippocampiConnectivityTemplateInSubjectSpace = os.path.join( 
                        outputDirectory,
                        'hippocampi-connectivity-template-in-dw-space.bundles' )
        ...
        'parameters' : \
          { 'fileNameInputBundleMaps' : str( 
            ...
            'fileNameOutputBundleMaps' : str( 
                         fileNameHippocampiConnectivityTemplateInSubjectSpace ),
